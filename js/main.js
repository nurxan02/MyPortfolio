(function ($) {
  ...
  function changeLangAz() {
    $(".az").click(function () {
      ...
      $("#cvJoinCourse").text("Kursuma qoşulun !");
  ...
  function changeLangEn() {
    $(".en").click(function () {
      ...
      $("#cvJoinCourse").text("Join My Course !");
  ...
  function changeLangPl() {
    $(".pl").click(function () {
      ...
      $("#cvJoinCourse").text("Dołącz do mojego kursu !");
  ...
  function changeLangRu() {
    $(".ru").click(function () {
      ...
      $("#cvJoinCourse").text("Присоединиться к моему курсу !");
